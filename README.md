...
You will need to use my version of Marlin because I made the raster moves move exactly on the x-axis, whereas in previous versions of this repository, each line moves just a tiny bit on the y axis. Now the line is changed with a specific G0 command.
...
1. Things were moved around a bit, namely the decisions about what and how to cut.
